...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <main>
        <Navbar />
        <div className=' flex flex-col justify-center items-center bg-[url("/bg.png")]  md:bg-[url("/bg.png")] w-full h-full bg-no-repeat bg-cover md:bg-top bg-bottom  bg-fixed'>
