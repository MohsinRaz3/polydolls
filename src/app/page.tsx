      ...
      <main className=' bg-[url("/bg.png")] bg-no-repeat bg-center  w-full h-full  bg-fixed' >
        ...
        <div className=' flex flex-col justify-center items-center  md:bg-[url("/bg.png")] w-full h-full bg-no-repeat bg-cover md:bg-top bg-center  bg-fixed'>
          <div className='w-full flex flex-col items-center '>
            ...
            <p className={`${humourFont.className} text-stroke  text-xs md:text-sm visible md:invisible whitespace-pre-wrap pr-16 leading-[1.2rem] -mb-24 text-white`}>18,000 POLYGON CITIZENS,  <br /> &ensp; EAGER FOR THEIR ANCESTRAL NEST. <br />&ensp;  MINT NOW TO PAV THEIR VOYAGE HOME <br /> &ensp;  &ensp;  &ensp;  &ensp;      AND SECURE COMMERCIAL RIGHTS.</p>  
            <p className={`${humourFont.className} invisible md:visible md:text-sm whitespace-pre-wrap pr-28 leading-[1.5rem] mb-1 text-white`}>18,000 POLYGON CITIZENS,  <br /> &ensp;  EAGER FOR THEIR ANCESTRAL NEST. <br />&ensp;   MINT NOW TO PAV THEIR VOYAGE HOME <br /> &ensp;  &ensp;  &ensp;  &ensp; &ensp; &ensp;  AND SECURE COMMERCIAL RIGHTS.</p>  
              ...
              <Image src={"/ulogoo.png"} height={1000} width={500} className='mt-16 -mb-8 md:mt-2 md:w-[700px]' alt='polydolls logo Nfts'></Image> </motion.h1>
              </div>    
            ...
            <div className=' w-full pt-0 md:pt-8 md:my-0 lg:my-0 flex flex-col items-center'>
              ...
              <div className={`${humourFont.className} text-center mx-auto px-3 w-full text-stroke text-white text-xs md:my-20 lg:my-28 `}>
                ...
                <Image src={"/faqbbb.png"} height={1080} width={1920} className='md:hidden -z-10 mt-8 -mb-10 pl-9 md:mb-0 md:mt-0 md:w-[1920px]' alt='faqm'></Image>
                <Image src={"/faqaaa.png"} height={1080} width={1920} className='invisible md:visible pl-14 md:mb-52 sm:mt-2 md:w-[1920px]  h-[400px]' alt='polydolls logo Nfts'></Image>
                <p className=' visible md:invisible leading-[1.2rem] -mt-96 mb-24'>FREQUENTLY ASKD QUESTION AND <br /> DETAILED MINTING GUIDE  <Link target='_blank' href={"/License"}><span className='text-[#11B8CC] text-stroke'> HERE.</span></Link></p>
