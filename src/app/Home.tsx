...
export default function Home() {
    return (
        <main>
            <Navbar />
            <div className='border-2 border-white flex flex-col justify-center items-center bg-[url("https://res.cloudinary.com/dj23jud85/image/upload/v1697451403/bg_sfjmts.webp")] w-full h-full bg-no-repeat bg-center bg-cover bg-fixed'>
